...
class Ball {
    ...
    checkPaddleCollision(paddle) {
        ...
        const difficulty = Game.settings ? Game.settings.difficulty() : CONFIG.DIFFICULTY.NORMAL;
        const newSpeed = Math.min(speed + CONFIG.BALL.SPEED_INCREMENT, CONFIG.BALL.MAX_SPEED * difficulty.maxSpeed);
    ...
    draw() {
        ...
        const useShadows = !Game.settings || Game.settings.shadows();
        if (this.fireball && useShadows) {
            ctx.shadowBlur = 25;
