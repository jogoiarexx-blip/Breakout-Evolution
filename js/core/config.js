...
const CONFIG = {
    ...
    DIFFICULTY: {
        EASY:   { label: 'Fácil', ballSpeed: 0.82, maxSpeed: 0.88, paddleScale: 1.18, lives: 5 },
        NORMAL: { label: 'Normal', ballSpeed: 1.00, maxSpeed: 1.00, paddleScale: 1.00, lives: 3 },
        HARD:   { label: 'Difícil', ballSpeed: 1.18, maxSpeed: 1.15, paddleScale: 0.88, lives: 2 }
    },

    GRAPHICS: { DEFAULT: 'AUTO' },
